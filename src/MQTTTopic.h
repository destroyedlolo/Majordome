...
public :
	...
	StringVector namedminmaxes;	// MinMax to launch at message arrival
...
public:
	...
	void addNamedMinMax( std::string t ){ this->namedminmaxes.Add(t); }
	void execNamedMinMax( Config &, const char *name, const char *topic, const char *payload );
