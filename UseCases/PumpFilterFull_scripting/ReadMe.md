...
> [!TIP]
> Majordome’s built‑in objects are designed to cover the majority of use cases.
> However, there are situations where the decision mechanism reaches
> the limits of what is available out of the box.
> In those cases, low‑level Lua scripting can come into play.  
