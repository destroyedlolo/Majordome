...
SelLog.Log('I', "Le soleil se couche à ".. ("%02d:%02d"):format(h,m))
...
SelLog.Log('I', "Début de la surveillance solaire à ".. ("%02d:%02d"):format(h,m))
h,m = HeureFinSurveillanceCoucherSoleil:getAtHM()
SelLog.Log('I', "Fin de la surveillance solaire à ".. ("%02d:%02d"):format(h,m))
